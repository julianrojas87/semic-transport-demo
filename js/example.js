...
planner.addConnectionSource("https://openplanner.ilabt.imec.be/sncf/connections");
planner.addStopSource("https://openplanner.ilabt.imec.be/sncf/stops");
...
planner.getAllStops().then(stops => {
  ...
  for (const stop of stops) {
    i++;
    if (stop["avgStopTimes"] > 100000 || (stop["avgStopTimes"] < 0 && i % 20 === 0)) {
